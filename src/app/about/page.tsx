...
import { Coffee, Droplets, Award, Truck } from 'lucide-react';
      ...
      <div className="pt-28 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-pd-cream mb-6">قصة <span className="text-pd-gold">Press&Drink</span></h1>
            <p className="text-pd-accent/60 text-lg leading-relaxed max-w-2xl mx-auto">نؤمن بأن القهوة ليست مجرد مشروب، بل هي تجربة. من هنا جاءت فكرة Press&Drink — جلب تجربة القهوة الممتازة إلى يدك في أي وقت وأي مكان.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-pd-cream">كيف بدأنا؟</h2>
              <p className="text-pd-accent/60 leading-relaxed">بدأت Press&Drink برؤية بسيطة: جعل القهوة الممتازة متاحة للجميع، في أي وقت وأي مكان. لاحظنا أن معظم الناس يضطرون للتنازل عن جودة القهوة بسبب انشغالهم، فقررنا أن نغير ذلك.</p>
              <p className="text-pd-accent/60 leading-relaxed">باستخدام تقنية حفظ النيتروجين المتطورة، تمكنا من حبس نكهة القهوة الطازجة في كبسولة صغيرة أنيقة. النتيجة؟ قهوة ممتازة بنقرة واحدة.</p>
            </div>
            <div className="bg-gradient-to-br from-pd-coffee/30 to-pd-dark rounded-3xl p-8 border border-pd-gold/10 flex items-center justify-center">
              <div className="text-center">
                <Coffee className="w-20 h-20 text-pd-gold/30 mx-auto mb-4" />
          ...
          <div className="bg-gradient-to-br from-pd-coffee/20 to-pd-dark rounded-3xl p-8 md:p-12 border border-pd-gold/10 text-center">
            ...
            <p className="text-pd-accent/60 mb-6">هل لديك استفسار أو اقتراح؟ نحن هنا للمساعدة</p>
            <a href="https://wa.me/201064688315" target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-whatsapp text-white px-8 py-3 rounded-full font-semibold hover:bg-whatsapp-dark transition-colors">تواصل عبر واتساب</a>
          </div>
        </div>
      </div>
      <Footer />
